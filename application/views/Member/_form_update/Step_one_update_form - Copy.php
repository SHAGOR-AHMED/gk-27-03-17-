    ...
    <form method="POST" action="" id="frm_step_one_update_form" enctype="multipart/form-data">
      ...
      <div class="col-md-3">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="education" name="education" placeholder="Enter educational status" value="<?= $member->educational_status; ?>" required>
        </div>                     
      </div>
      <div class="col-md-3">     
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="where_live" name="where_live" placeholder="Enter where do you live?" value="<?= set_value('where_live'); ?>" disabled>
        </div>
        <div class="form-group">
