...
<html lang="en">
  <head>
    ...
    <title>Gonoshasthaya Microcredit System | Attendence</title>
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 col-lg-offset-3 col-md-offset-3 col-sm-offset-3 col-xs-offset-1">
              <div class="row login_bg">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="margin-top:35px">
                  <?= form_open('attendence_attempt', ['class' => 'form-horizontal']); ?>
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-8">
                          <button type="submit" class="btn btn-default btn-sm" name="attendence">Attendence</button>
                          <a class="btn btn-default btn-sm" href="<?= base_url('/'); ?>">Go Home</a>
                        </div>
                      </div>
                      <div class="form-group">
    ...
    <footer class="footer">
      <div class="container-fluid">
        <span class="text-muted">
          <strong>Copyright &copy; <?= date('Y'); ?> <a href="javascript:">GMS</a>.</strong> All rights reserved.
        </span>
