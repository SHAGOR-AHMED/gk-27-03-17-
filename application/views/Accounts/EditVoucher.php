<?php view('inc.Header'); ?>
    ...
    <section class="content">
      ...
      <div class="box box-info">
        ...
        <form id="VoucherForm" action="<?= base_url('/voucher_create'); ?>" method="post">
            <input type="hidden" name="voucher_id" value="<?php echo $voucherInfo->id ?>">
            <div class="row">
                <!-- <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="reg_branch" id="reg_branch" onchange="getBranchList(this);" required>
                          ...
                          <?php foreach ($regBranchList as $reg_branch) {
                            if($reg_branch->id == $voucherInfo->reg_branch_id) {
                              echo '<option value="'. $reg_branch->id .'" selected>'.$reg_branch->name.'</option>';
                            } else{
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="branch" id="branch" required>
                          ...
                          <?php foreach ($branchList as $branch) {
                            if($branch->id == $voucherInfo->branch_id) {
                ...
                <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control datepicker" data-date-format="yyyy-mm-dd" id="voucher_date" name="voucher_date" placeholder="Enter date" value="<?= $voucherInfo->voucher_date; ?>" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                      <label for="voucher_caption">Voucher Caption</label>
                      <input type="text" class="form-control" id="voucher_caption" name="voucher_caption" value="<?= $voucherInfo->voucher_caption; ?>" placeholder="Enter voucher caption">
                    </div>
                </div>
            </div>
            ...
            <div id="grid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <select class="form-control" name="tran_head[]" required>
                                ...
                                <?php
                                  foreach($tran->tranHeads as $v) {
                                    if($v->id == $tran->tran_head) {
                                      echo '<option value="'.$v->id.'" selected>'.$v->name.'</option>';
                                    } else {
                                      echo '<option value="'.$v->id.'">'.$v->name.'</option>';
                                    }                                    
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                          <input type="text" class="form-control text-right" name="debit_amount[]" placeholder="Debit amount" required value="<?php echo $tran->debit ?>">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                          <input type="text" class="form-control text-right" name="credit_amount[]" placeholder="Credit amount" required value="<?php echo $tran->credit ?>">
                        </div>
                    </div>
                    <div class="col-md-2">
            ...
            <div class="row">
                 ...
                 <div id="debit-amount" class="col-md-2 text-right" style="border-top:1px solid #000"><?php echo $total_debit ?></div>
  ...
  <div id="vourcher-row" style="display:none">
      <div class="row">
        ...
        <div class="col-md-2">
            <div class="form-group">
              <input type="text" class="form-control text-right" name="debit_amount[]" placeholder="Debit amount" required>
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
              <input type="text" class="form-control text-right" name="credit_amount[]" placeholder="Credit amount" required>
            </div>
        </div>
        <div class="col-md-2">
            <span class="glyphicon glyphicon-trash remove-row" style="color:#d15b47; margin-top:8px; cursor:pointer"></span>
