<?php view('inc.Header'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>for Receive Payment</small>
      </h1>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-info">
        ...
        <div class="box-body">
        <form action="<?= base_url('/income_statement_report'); ?>" method="post" id="ReportForm">
              ...
              <?php endif; ?>
                <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control datepicker" data-date-format="yyyy-mm-dd" id="from_date" name="from_date" placeholder="Enter date" value="<?= date('Y-m-01'); ?>" required>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                      <label for="voucher_date">To <span class="text-red">*</span></label>
                      <input type="text" class="form-control datepicker" data-date-format="yyyy-mm-dd" id="to_date" name="to_date" placeholder="Enter date" value="<?= date('Y-m-t'); ?>" required>
                    </div>
                </div>
