        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Search Asset</h3>
              <div class="box-tools pull-right"></div>
            </div>
            <div class="box-body color-black">
              <div class="row">
                <form action="<?= base_url('search_asset'); ?>" method="GET">
                  <div class="col-md-3">
                    ...
                    <tbody>
                      <?php if(!empty($assetList)){ foreach ($assetList as $asset) { ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?= base_url('/edit/asset').'/'. $asset->id ; ?>">Edit&nbsp;<i class="fa fa-edit"></i></a> | 
