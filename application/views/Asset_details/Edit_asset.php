      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="row">
                  <form action="<?= base_url('update_asset_allocation'); ?>" method="POST">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="sub_category_name" name="sub_category_name" required>
                              <option value="<?= $asset->subCatID; ?>"><?= $asset->subCatName; ?></option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" id="asset_quantity" name="asset_quantity" required>
                              <option value="<?= $asset->quantity; ?>"><?= $asset->quantity; ?></option>
                              <?php for ($i=1; $i <100 ; $i++) { 
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="reg_branch" id="reg_branch" onchange="getBranchList(this);" required>
                              ...
                              <?php if(!empty($regionalbranchList)){ foreach ($regionalbranchList as $reg_branch) { ?>
                                <option value="<?= $reg_branch->id; ?>" <?= ($asset->reg_branch_id == $reg_branch->id)? 'selected' : ''; ?> ><?= $reg_branch->name; ?></option>
                              <?php } } ?>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="branch" id="branch" onchange="getSomitiList(this);" required>
                              <option value="<?= $asset->branchID; ?>"><?= $asset->branchName; ?></option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" id="location_name" name="location_name">
                              ...
                              <?php if(!empty($asset_locationList)) { foreach ($asset_locationList as $location) { ?>
                                <option value="<?= $location->id; ?>" <?= ($asset->asset_location_id == $location->id)? 'selected' : ''; ?>><?= $location->name; ?></option>
                              <?php } } ?>
                            </select>
                        </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="asset_description" name="asset_description" placeholder="Enter asset description" value="<?= $asset->description; ?>" required>
                        </div>
                            <div class="form-group">
                                <label for="asset_unit_price">Unit price <span class="text-red">*</span></label>
                                <input type="text" class="form-control" id="asset_unit_price" name="asset_unit_price" placeholder="Enter asset unit price" value="<?= $asset->unit_price; ?>" required>
                            </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                                <label for="issue_date">Issue date <span class="text-red">*</span></label>
                                <input type="text" class="form-control datepicker"  data-date-format="yyyy-mm-dd" id="issue_date" name="issue_date" placeholder="Enter purchase date" value="<?= $asset->issue_date; ?>" required>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                                <label for="purchase_date">Purchase date <span class="text-red">*</span></label>
                                <input type="text" class="form-control datepicker"  data-date-format="yyyy-mm-dd" id="purchase_date" name="purchase_date" placeholder="Enter purchase date" value="<?= $asset->purchase_date; ?>" required>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-md-3">
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                                <label for="damaged_asset_quantity">Damaged Qty <span class="text-red">*</span></label>
                                <input type="text" class="form-control" id="damaged_asset_quantity" name="damaged_asset_quantity" placeholder="Quantity of damaged asset" value="<?= $asset->damaged_asset_quantity; ?>" required>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                                <label for="usable_asset_quantity">Usable asset <span class="text-red">*</span></label>
                                <input type="text" class="form-control" id="usable_asset_quantity" name="usable_asset_quantity" placeholder="Usable asset" value="<?= ($asset->quantity-$asset->damaged_asset_quantity); ?>" readonly>
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                            <label for="asset_used_by">Asset used by <span class="text-red">*</span></label>
                            <input type="text" class="form-control" id="asset_used_by" name="asset_used_by" placeholder="Person responsible to the asset" value="<?= $asset->asset_used_by; ?>" required>
                        </div>
                        <div class="form-group">
